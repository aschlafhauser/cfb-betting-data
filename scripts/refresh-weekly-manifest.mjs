...
const [deep,movers,upsetResearch,ud,ls,ledgerSync,previousManifest,statArtifact,marketArtifact]=await Promise.all([
...
const gates={
 ...
 productionVerifier,preKickoffSnapshots:{status:'IN_PROGRESS',detail:'Immutable 60–90 minute final snapshots remain required individually through kickoff.'}
};
